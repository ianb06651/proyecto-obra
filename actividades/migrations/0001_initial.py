# Generated by Django 5.2.4 on 2025-09-18 23:40
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('meta_cantidad_total', models.DecimalField(decimal_places=2, default=0.0, help_text='Usar solo si la meta es general y no se desglosa por zona.', max_digits=12, verbose_name='Meta de Cantidad (si no aplica por zona)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cantidad_realizada_dia', models.DecimalField(decimal_places=2, default=0, help_text='Llenar este campo solo si el avance del día no se desglosa por zonas.', max_digits=12, verbose_name='Avance General (si no aplica por zona)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('cantidad_realizada', models.DecimalField(decimal_places=2, default=0, max_digits=12, verbose_name='Cantidad Realizada en esta Zona')),
                ('avance_diario', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='actividades.avancediario')),
        ...
        migrations.AddField(
            ...
            name='zonas',
            field=models.ManyToManyField(blank=True, through='actividades.AvancePorZona', to='actividades.areadetrabajo'),
        ),
        migrations.AddField(
            model_name='avancediario',
            name='empresa',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('meta_cantidad', models.DecimalField(decimal_places=2, default=0, max_digits=12, verbose_name='Meta de Cantidad para esta Zona')),
        ...
        migrations.AddField(
            ...
            name='zonas_con_meta',
            field=models.ManyToManyField(blank=True, through='actividades.MetaPorZona', to='actividades.areadetrabajo', verbose_name='Desglose de Metas por Zona'),
        ),
        migrations.AddField(
            model_name='actividad',
            name='partida',
        ...
        migrations.AddField(
            model_name='actividad',
            name='proyecto',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='actividades', to='actividades.proyecto'),
        ),
        migrations.CreateModel(
            name='TipoMaquinaria',
            fields=[
